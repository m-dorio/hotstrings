...
export default function Footer() {
    ...
    let replaceDate = () => {
        ...
        for (let i = 0; i < updatedDates.length; i++) {
            modate = document.querySelectorAll("#w-update").innerHTML = "Date: " + new Date(modate).toString();
    ...
    return(
        ...
        <footer id="footer" className="px-3 py-2 d-flex align-items-end justify-content-between bg-color">
        ...
        <div className="text-white">
            <small id="w-update" className="text-white">Dynamic date</small>
        </div>  
        </footer>
